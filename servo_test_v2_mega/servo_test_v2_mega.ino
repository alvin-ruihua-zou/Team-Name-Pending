...
// Drive robot backwards until IR sensor detects an edge.
...
// Command the robot using a series of commands.
// Each command is delimited by ":" (command sequences needs to end with ":" as well)
void multi_command()
{
...
// Command the robot using a single command.
